...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.rama.admin.domain.User.class.getName(), jcacheConfiguration);
            cm.createCache(com.rama.admin.domain.Authority.class.getName(), jcacheConfiguration);
